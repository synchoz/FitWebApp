...
export default function AdminWeightLogs() {
    ...
    return (
        <div className='bg-white rounded-xl shadow-sm border border-gray-100 p-5'>
            ...
            {!selectedUserId ? (
                <div className='py-6 text-center text-gray-400 text-sm'>Select a user to view their weight logs.</div>
            ) : logs.length === 0 ? (
                <div className='py-6 text-center text-gray-400 text-sm'>No weight logs for this user.</div>
            ) : (
